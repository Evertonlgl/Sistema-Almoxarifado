<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePedidoEmpresa.master" AutoEventWireup="true" CodeFile="PgAlteraSenhaEmpresa.aspx.cs" Inherits="PgAlteraSenhaEmpresa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphEmpresa" Runat="Server">
    ...
    <div style="width: 895px; margin-left: 26px; margin-right: 22px; margin-top: 32px">
            ...
            <asp:Label ID="lblCnpjLogin" runat="server" Text="CNPJ "></asp:Label>
            <asp:TextBox ID="txtCnpjLogin" runat="server" style="margin-left: 63px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="rfvcpf" SetFocusOnError="true" ControlToValidate="txtCnpjLogin" ErrorMessage="Preencha o Cnpj" runat="server" ValidationGroup="Alterasenha"></asp:RequiredFieldValidator>
            <br />
            <br />
